...
{
	return InvSqrt((RealMidLine1[row1] - RealMidLine1[row2]) * (RealMidLine1[row1] - RealMidLine1[row2])
				   + (RealMidLine2[row1] - RealMidLine2[row2]) * (RealMidLine2[row1] - RealMidLine2[row2]));
}
