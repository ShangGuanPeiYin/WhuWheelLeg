...
float PID_Roll(float nowdata, float target, float zero)	   // 位置式PID1
{
	...
	pid_init.pid_roll.output	= pid_init.pid_roll.kp * pid_init.pid_roll.ek + pid_init.pid_roll.ki * pid_init.pid_roll.integral
...
float PID_Speed1(float nowdata, float target)	 // 增量式，速度环1
{
	...
	pid_init.pid_speed1.output
		+= pid_init.pid_speed1.kp * (pid_init.pid_speed1.ek - pid_init.pid_speed1.ek1)
...
float PID_Speed2(float nowdata, float target)	 // 增量式，速度环2
{
	...
	pid_init.pid_speed2.output
		+= pid_init.pid_speed2.kp * (pid_init.pid_speed2.ek - pid_init.pid_speed2.ek1)
...
float PID_Roll_Speed(float nowdata, float target)	 // 角速度增量式
{
	...
	pid_init.pid_roll_speed.output
		+= pid_init.pid_roll_speed.kp * (pid_init.pid_roll_speed.ek - pid_init.pid_roll_speed.ek1)
		   + pid_init.pid_roll_speed.ki * pid_init.pid_roll_speed.ek
		   + pid_init.pid_roll_speed.kd
				 * (pid_init.pid_roll_speed.ek - 2.0f * pid_init.pid_roll_speed.ek1 + pid_init.pid_roll_speed.ek2);
...
float PID_SERVO(float nowdata, float target)
{
	...
	pid_init.pid_servo.output = pid_init.pid_servo.kp * pid_init.pid_servo.ek + pid_init.pid_servo.ki * pid_init.pid_servo.integral
