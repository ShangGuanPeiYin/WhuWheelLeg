...
/**
 * @brief 显示图像
 *需设置seekfree_assistant_camera_information_config(SEEKFREE_ASSISTANT_MT9V03X, image_copy[0], COL, ROW);设置摄像头信息给上位机显示
 */
void ShowImage(void)
{
...
/**
 * @brief 显示左右电机力矩
 *需设置seekfree_assistant_oscilloscope_data.channel_num;示波器通道数
 */
