...
clean-code-2f-src:
	-$(RM) ./code/src/Brushless.d ./code/src/Brushless.o ./code/src/Brushless.src ./code/src/Camera.d ./code/src/Camera.o ./code/src/Camera.src ./code/src/MathLib.d ./code/src/MathLib.o ./code/src/MathLib.src ./code/src/Pid.d ./code/src/Pid.o ./code/src/Pid.src ./code/src/ServoMotor.d ./code/src/ServoMotor.o ./code/src/ServoMotor.src ./code/src/key.d ./code/src/key.o ./code/src/key.src ./code/src/leg.d ./code/src/leg.o ./code/src/leg.src ./code/src/oledDebug.d ./code/src/oledDebug.o ./code/src/oledDebug.src ./code/src/robot.d ./code/src/robot.o ./code/src/robot.src
